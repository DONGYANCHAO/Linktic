        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
              <button class="text-emerald-600 hover:text-emerald-900" @click="openModal(product)">
                Editar
              </button>
              <button class="text-blue-600 hover:text-blue-900" @click="viewInventory(product.id)">
                Inventario
              </button>
            </td>
          </tr>
