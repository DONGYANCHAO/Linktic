        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
              <button @click="openModal(product)" class="text-emerald-600 hover:text-emerald-900">
                Editar
              </button>
              <button @click="viewInventory(product.id)" class="text-blue-600 hover:text-blue-900">
                Inventario
              </button>
            </td>
          </tr>
