        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="item in inventory" :key="item.productId" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <span
                :class="
                  item.available > 5 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                "
      ...
      <div class="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
        ...
        <form class="space-y-4" @submit.prevent="handleInitInventory">
          ...
          <div>
            ...
            <input
              v-model.number="initForm.available"
              type="number"
              min="0"
          ...
          <div class="flex justify-end space-x-3 mt-6">
            <button type="button" class="px-4 py-2 text-gray-400" @click="isInitModalOpen = false">
              Cancelar
            </button>
